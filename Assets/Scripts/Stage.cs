...
public class Stage : MonoBehaviour
{
    //필요 소스 불러오기
    [Header("Source")]
    public GameObject tilePrefab; // 타일 프리펩 가져오기
    ...
    void CheckBoardColumn()
    {
        ...
        if (linecount != 0)
        {
            ...
            if (lineVal <= 0 && levelVal <= 10)
            {
                ...
                fallCycle = 0.08f * (10 - levelVal); // 속도 증가
            }
            level.text = "" + levelVal;
            line.text = "" + lineVal;
        }
    ...
    void CreateBackground()
    {
        ...
        // 타일 보드
        color.a = 0.6f; // 테두리와 구분 위해 투명도 바꾸기
    ...
    void CreateTetromino()
    {
        ...
        switch (index)
        {
            ...
            case 0: // I
                color = new Color32(112, 248, 224, 255);    // 하늘색
            ...
            case 1: // J
                color = new Color32(0, 73, 245, 255);    // 파란색
                CreateTile(tetrominoNode, new Vector2(-1f, 0.0f), color);
                CreateTile(tetrominoNode, new Vector2(0f, 0.0f), color);
                CreateTile(tetrominoNode, new Vector2(1f, 0.0f), color);
            ...
            case 3: // O 
                color = new Color32(251, 230, 0, 255);    // 노란색
            ...
            case 6: // Z
                color = new Color32(217, 49, 32, 255);    // 빨간색
                CreateTile(tetrominoNode, new Vector2(-1f, 1f), color);
                CreateTile(tetrominoNode, new Vector2(0f, 1f), color);
                CreateTile(tetrominoNode, new Vector2(0f, 0f), color);
                CreateTile(tetrominoNode, new Vector2(1f, 0f), color);
